...
object Constants {
    ...
    const val RANGE_OF_RESPONSES = "responses!B2:F100"
    const val SUBJECTS = "AppPreferences:subjects"
    const val INDEX = "AppPreferences:INDEX"
    const val IS_DOCTOR = "AppPreferences:IS_DOCTOR"
    const val IS_VERIFIED = "AppPreferences:IS_VERIFIED"
    val ARRAY_OF_SUBJECTS = listOf(
